          ...
          <div v-if="player.on_field">
            ...
            <div v-if="player.play_status.type == 'playing'" class="row-container"> 
              ...
              <div style="margin: auto 0px;" class="row-container" v-for="point_source in player.point_sources.filter(p => p.points_total != 0)" >
                ...
                <div style="margin: auto; height: 12px;" v-for="x in point_source.amount" v-if="point_source.stat == 'penalties_missed'"> 
